...
framerate = 30;%Xuming changed it on 2021-02-01
...
for curr_cell = 1:num_rois;
    ...
    for baseline_est = 1:baseline_est_runs;
        ...
        % over threshold.
        noise_smooth_mode = noise_smooth_mode(1,1); % Irina add
...
%         curr_trace = inactive_trace;
    ...
    %%%%%% NOTE: 150803 - removed this for Simon AP
...
%      end
    ...
    baseline_offset = baseline_offset(1,1); % Irina add
